...
contador = 1
ruta_archivo = ""
colores = ["green", "black", "withe", "red", "blue", "orange", "purple"] 
lista = [["xd"]]
def app(root):
    ...
    def datosAutomatico():
        ...
        button_empezarA_f1.place(relx= 0.5, rely=0.65,anchor="center")
    ...
    def empezarRutaAutomatica():
        ...
        x = 0
        y = 0
        coordenadasD, rutas = archivoExcel(ruta_archivo, entry_labelh.get(), entry_labelh2.get(),entry_labelh3.get())
        print(coordenadasD)
        ...
        for ruta  in rutas:
                for i in ruta:
                    if i!=0 :
                        contador = str(contador)
                        coordenadas[i].set_text(coordenadas[i].text + "\nDestino N°" + contador)
                        coordenadasO.append(coordenadas[i].position)
                        contador = int(contador)
                        contador = contador+1
                coordenadasO.append(almacen.position)
                crearRuta = map_widget.set_path([elemento for elemento in coordenadasO],color="green")
                coordenadasO = []
        ...
        if(len(coordenadas)<2):
            ...
            for ruta  in rutas:
                for i in ruta:
                    if i!=0 :
                        contador = str(contador)
                        coordenadas[i][0].set_text(coordenadas[i][2] + "\nDestino N°" + contador)
                        coordenadasO.append(coordenadas[i][0].position)
                        contador = int(contador)
                        contador = contador+1
                coordenadasO.append(almacen.position)
                crearRuta = map_widget.set_path([elemento for elemento in coordenadasO],color="green")
    ...
    button4_f3 = tk.Button(frame3,text="Empezar una ruta nueva", bg="gray",fg="white",width = 200, height =3)
